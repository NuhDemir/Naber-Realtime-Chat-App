...
const NoChatSelected = () => {
  ...
  return (
    <div className="w-full flex-1 flex flex-col items-center justify-center p-4 sm:p-10 bg-base-100">
      <motion.div
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-col items-center gap-3">
          <motion.div
            className="size-20 rounded-2xl bg-primary/10 flex items-center justify-center"
        ...
        >
          <div className="card bg-base-200/60 p-4 rounded-xl flex flex-row items-center gap-4">
            <div className="bg-primary/20 p-2 rounded-full">
              <Users className="size-5 text-primary" />
            </div>
            <div>
              <h3 className="font-semibold text-sm text-left">Kişileri Keşfet</h3>
          ...
          <div className="card bg-base-200/60 p-4 rounded-xl flex flex-row items-center gap-4">
            ...
            <div>
              <h3 className="font-semibold text-sm text-left">Anında Mesajlaş</h3>
