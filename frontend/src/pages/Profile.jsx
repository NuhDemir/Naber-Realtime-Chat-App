      ...
      <div className="max-w-2xl mx-auto p-4 sm:p-6">
        <div className="bg-base-100 rounded-xl p-6 shadow-md border border-base-300">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 mt-1">Kişisel bilgilerinizi yönetin</p>
          </div>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-sm text-zinc-500">
              {isUpdatingProfile ? "Yükleniyor..." : "Fotoğrafı değiştirmek için kameraya tıkla"}
            </p>
          </div>
          ...
          <div className="mt-8">
            <div className="flex justify-between items-center mb-4">
              ...
              {!isEditing ? (
                ...
                <div className="flex gap-2">
                  <button onClick={handleUpdateDetails} className="btn btn-success btn-sm">
                    <Save size={16} /> Kaydet
                  </button>
            ...
            {isEditing ? (
              ...
              <form onSubmit={handleUpdateDetails} className="space-y-4">
                <div className="form-control">
                  <label className="label">
                    <span className="label-text flex items-center gap-2"><User size={14}/> Full Name</span>
                  </label>
                  <input type="text" name="fullName" value={formData.fullName} onChange={handleInputChange} className="input input-bordered w-full" />
                </div>
                <div className="form-control">
                  <label className="label">
                    <span className="label-text flex items-center gap-2"><Mail size={14}/> Email Address</span>
                  </label>
              ...
              <div className="space-y-4">
                <div className="form-control">
                  <label className="label"><span className="label-text text-zinc-400 flex items-center gap-2"><User size={14}/> Full Name</span></label>
                  <p className="px-1 text-base">{authUser?.fullName}</p>
                </div>
                <div className="form-control">
                  <label className="label"><span className="label-text text-zinc-400 flex items-center gap-2"><Mail size={14}/> Email Address</span></label>
          ...
          <div className="mt-6 bg-base-200/50 rounded-xl p-4">
            ...
            <div className="flex items-center justify-between py-2">
              ...
              <span className="badge badge-success badge-sm text-white">Aktif</span>
            </div>
          </div>
